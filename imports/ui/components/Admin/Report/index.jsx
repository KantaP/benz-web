    ...
    >
        ...
        <Row className="mr-0 ml-0 p-3" style={{justifyContent:'space-between' , backgroundColor:'#000'}}>
            ...
            <Row className="mr-0 ml-0 p-1" style={{alignItems:'center' }} >
                ...
                <div style={{color:'#fff' , marginLeft: 10}}>Ticket Report</div>
            </Row>
            {/* Search */}
        ...
        <Row className="mr-0 ml-0 p-3" style={{justifyContent:'space-between'}}>
            <Row className="mr-0 ml-0 p-1" style={{alignItems:'center' }}>
                <div>Total Report: {state.count}</div>
            </Row>
            <Row className="mr-0 ml-0 p-1" style={{alignItems:'center' }}>
                ...
                (
                    <div>
                        ...
                        <Form style={customStylesForm}>
                            ...
                            <FormGroup row style={{alignItems:'center'}}>
                                <Label className="customLabel" sm={3}>Type</Label>
                                <Col sm={9}>
                                    {state.type}
                                </Col>
                            </FormGroup>
                            ...
                            <FormGroup row>
                                <Label className="customLabel" sm={3}>Status</Label>
                                <Col sm={9}>
                                    {state.status}
                                </Col>
                            </FormGroup>
